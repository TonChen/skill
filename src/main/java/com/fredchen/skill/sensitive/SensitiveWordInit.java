...
public class SensitiveWordInit {
	...
	private Set<String> readSensitiveWordFile() throws Exception {
		...
		File file = new File("E:\\work\\project\\hhsc\\src\\sensitive.properties"); // 读取文件
//		InputStream in = this.getClass().getClassLoader().getResourceAsStream("sensitive1.properties");
